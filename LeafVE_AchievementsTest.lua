...
function LeafVE_AchTest.UI:Build()
  ...
  header:SetBackdropColor(0.11, 0.09, 0.07, 1.00)
  header:SetBackdropBorderColor(0.50, 0.38, 0.16, 0.95)
  local headerArt = header:CreateTexture(nil, "BACKGROUND")
  headerArt:SetAllPoints(header)
  headerArt:SetTexture(TEX.header)
  headerArt:SetVertexColor(1, 1, 1, 0.82)
  ...
  pointsFrame:SetBackdropColor(0.10, 0.08, 0.06, 0.98)
  pointsFrame:SetBackdropBorderColor(0.52, 0.40, 0.18, 0.95)
  ...
  sidebarFrame:SetBackdrop({
    bgFile   = TEX.categoryBg,
    edgeFile = "Interface\\Tooltips\\UI-Tooltip-Border",
    tile = false, tileSize = 16, edgeSize = 8,
    insets = {left=2, right=2, top=2, bottom=2},
  })
  sidebarFrame:SetBackdropColor(0.08, 0.07, 0.06, 0.98)
  sidebarFrame:SetBackdropBorderColor(0.38, 0.29, 0.12, 0.90)
  ...
  searchBox:SetBackdropColor(0.07, 0.06, 0.05, 0.95)
  searchBox:SetBackdropBorderColor(0.44, 0.33, 0.14, 1)
  ...
  titleSearchBox:SetBackdropColor(0.07, 0.06, 0.05, 0.95)
  titleSearchBox:SetBackdropBorderColor(0.44, 0.33, 0.14, 1)
  ...
  titleSidebarFrame:SetBackdropColor(0.08, 0.07, 0.06, 0.98)
  titleSidebarFrame:SetBackdropBorderColor(0.38, 0.29, 0.12, 0.90)
  ...
  scrollbar:SetBackdropColor(0.08, 0.08, 0.09, 0.85)
